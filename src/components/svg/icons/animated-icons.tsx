export const redux = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
    ...
    <circle
      class="skill-icon-Redux__clipPath-circle"
      fill="url(#match-background)"
      cx="16"
      cy="16"
      r="1"
    ></circle>
    <g id="skill-icon-Redux" clip-path="url(#skill-icon-Redux__clipPath)">
      <path
        d="M21.401 21.274a1.996 1.996 0 001.782-2.067 2.001 2.001 0 00-1.996-1.924h-.071a1.993 1.993 0 00-1.924 2.066c.036.535.25.998.57 1.319-1.211 2.387-3.064 4.133-5.844 5.594-1.888.998-3.848 1.354-5.807 1.105-1.604-.214-2.85-.927-3.635-2.103-1.14-1.746-1.247-3.634-.285-5.523.677-1.354 1.746-2.351 2.423-2.85a19.217 19.217 0 01-.463-1.817c-5.167 3.741-4.632 8.8-3.064 11.188 1.175 1.782 3.563 2.886 6.2 2.886.712 0 1.425-.07 2.137-.249 4.561-.89 8.017-3.599 9.977-7.625zm6.271-4.419c-2.708-3.171-6.699-4.917-11.26-4.917h-.57a1.958 1.958 0 00-1.745-1.07h-.072a1.994 1.994 0 00-1.924 2.068 2.002 2.002 0 001.996 1.924h.07a2.007 2.007 0 001.747-1.212h.641c2.708 0 5.274.784 7.59 2.316 1.781 1.176 3.064 2.708 3.777 4.561.605 1.497.57 2.958-.072 4.205-.997 1.888-2.672 2.922-4.881 2.922-1.425 0-2.78-.428-3.492-.749-.392.357-1.105.927-1.604 1.283 1.533.713 3.1 1.105 4.597 1.105 3.42 0 5.95-1.889 6.912-3.777 1.034-2.067.962-5.63-1.71-8.659zm-18.1 5.024a2.001 2.001 0 001.995 1.924h.071a1.993 1.993 0 001.924-2.066 2.001 2.001 0 00-1.995-1.924h-.071c-.072 0-.179 0-.25.035-1.46-2.423-2.066-5.06-1.853-7.91.143-2.138.856-3.991 2.103-5.523 1.033-1.319 3.028-1.96 4.382-1.996 3.777-.07 5.38 4.633 5.487 6.521.464.107 1.247.356 1.782.535-.428-5.773-3.99-8.766-7.411-8.766-3.207 0-6.165 2.316-7.34 5.737-1.64 4.56-.57 8.944 1.425 12.4-.178.25-.285.641-.25 1.033z"
        fill="#764abc"
        stroke-width=".109"
...
export const html = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
    ...
    <circle
      ...
      r={1}
    />
    <g id="skill-icon-HTML" clip-path="url(#skill-icon-HTML__clipPath)">
      <polygon
        points="5.902 27.201 3.655 2 28.345 2 26.095 27.197 15.985 30 5.902 27.201"
        style={{ fill: "#e44f26" }}
      />
...
export const css = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
    ...
    <circle
      ...
      r={1}
    />
    <g id="skill-icon-CSS" clip-path="url(#skill-icon-CSS__clipPath)">
      <polygon
        points="5.902 27.201 3.656 2 28.344 2 26.095 27.197 15.985 30 5.902 27.201"
        style={{ fill: "#1572b6" }}
      />
...
export const sass = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
    ...
    <circle
      ...
      r={1}
    />
    <g id="skill-icon-Sass" clip-path="url(#skill-icon-Sass__clipPath)">
      <path
        d="M26.11,17.572a5.8,5.8,0,0,0-2.537.588,5.345,5.345,0,0,1-.568-1.314,3.53,3.53,0,0,1-.051-1.1,9.811,9.811,0,0,1,.332-1.192c-.005-.051-.061-.292-.624-.3s-1.048.107-1.1.256a6.171,6.171,0,0,0-.235.834,19.686,19.686,0,0,1-1.713,3.294,3.186,3.186,0,0,1-.44-2.066,9.811,9.811,0,0,1,.332-1.192c-.005-.051-.061-.292-.624-.3s-1.048.107-1.1.256-.118.5-.235.834-1.483,3.386-1.841,4.173c-.184.4-.343.726-.455.946h0a.233.233,0,0,1-.02.041c-.1.189-.153.292-.153.292v.005c-.077.138-.159.266-.2.266a1.711,1.711,0,0,1,.01-.869c.2-1.059.69-2.705
(
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
    ...
    <g
      ...
      clip-path="url(#skill-icon-JavaScript__clipPath)"
    >
...
export const typescript = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
    ...
    <g
      ...
      clip-path="url(#skill-icon-TypeScript__clipPath)"
    >
      <polygon
        points="2 16 2 30 16 30 30 30 30 16 30 2 16 2 2 2 2 16"
        style={{ fill: "#007acc" }}
...
export const react = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
    ...
    <circle
      ...
      r={1}
    />
    <g id="skill-icon-React" clip-path="url(#skill-icon-React__clipPath)">
...
export const git = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
    ...
    <circle
      ...
      r={1}
    />
    <g id="skill-icon-Git" clip-path="url(#skill-icon-Git__clipPath)">
      <path
        d="M29.472,14.753,17.247,2.528a1.8,1.8,0,0,0-2.55,0L12.158,5.067l3.22,3.22a2.141,2.141,0,0,1,2.712,2.73l3.1,3.1a2.143,2.143,0,1,1-1.285,1.21l-2.895-2.895v7.617a2.141,2.141,0,1,1-1.764-.062V12.3a2.146,2.146,0,0,1-1.165-2.814L10.911,6.314,2.528,14.7a1.8,1.8,0,0,0,0,2.551L14.753,29.472a1.8,1.8,0,0,0,2.55,0L29.472,17.3a1.8,1.8,0,0,0,0-2.551"
        style={{ fill: "#dd4c35" }}
      />
...
export const npm = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
    ...
    <circle
      ...
      r={1}
    />
    <g id="skill-icon-NPM" clip-path="url(#skill-icon-NPM__clipPath)">
      <path
        d="M 2.6846088,10.906645 H 28.979394 v 8.389403 H 15.580319 l -0.719092,1.438183 -3.811186,0.143819 -0.575273,-1.582002 H 2.6846088 Z"
        fill="#fff"
      />
...
export const nodejs = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
    ...
    />
    <g
      id="skill-icon-NodeJS"
      clip-clip-path="url(#skill-icon-NodeJS__clipPath)"
    >
      <path
        d="M16,30a2.151,2.151,0,0,1-1.076-.288L11.5,27.685c-.511-.286-.262-.387-.093-.446a6.828,6.828,0,0,0,1.549-.7.263.263,0,0,1,.255.019l2.631,1.563a.34.34,0,0,0,.318,0l10.26-5.922a.323.323,0,0,0,.157-.278V10.075a.331.331,0,0,0-.159-.283L16.158,3.875a.323.323,0,0,0-.317,0L5.587,9.794a.33.33,0,0,0-.162.281V21.916a.315.315,0,0,0,.161.274L8.4,23.814c1.525.762,2.459-.136,2.459-1.038V11.085a.3.3,0,0,1,.3-.3h1.3a.3.3,0,0,1,.3.3V22.777c0,2.035-1.108,3.2-3.038,3.2a4.389,4.389,0,0,1-2.363-.642L4.661,23.788a2.166,2.166,0,0,1-1.076-1.872V10.075A2.162,2.162,0,0,1,4.661,8.2L14.922,2.276a2.246,2.246,0,0,1,2.156,0L27.338,8.2a2.165,2.165,0,0,1,1.077,1.87V21.916a2.171,2.171,0,0,1-1.077,1.872l-10.26,5.924A2.152,2.152,0,0,1,16,30Z"
        style={{ fill: "#83cd29" }}
...
export const mongodb = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
    ...
    <circle
      ...
      r={1}
    />
    <g id="skill-icon-MongoDB" clip-path="url(#skill-icon-MongoDB__clipPath)">
      <path
        d="M16.62,30l-.751-.249s.1-3.8-1.275-4.067c-.9-1.048.133-44.741,3.423-.149a2.712,2.712,0,0,0-1.333,1.523A14.1,14.1,0,0,0,16.62,30Z"
        style={{ fill: "url(#a)" }}
      />
...
export const mysql = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
    ...
    <circle
      ...
      r={1}
    />
    <g id="skill-icon-MySQL" clip-path="url(#skill-icon-MySQL__clipPath)">
      <path
        d="M8.785,6.865a3.055,3.055,0,0,0-.785.1V7h.038a6.461,6.461,0,0,0,.612.785c.154.306.288.611.441.917.019-.019.038-.039.038-.039a1.074,1.074,0,0,0,.4-.957,4.314,4.314,0,0,1-.23-.4c-.115-.191-.364-.287-.517-.44"
